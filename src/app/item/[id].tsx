...
const coffeeData: any = {
  "1": { title: "Espresso", price: "$2.99", image: require("../../assets/images/espresso.png") },
  "2": { title: "Latte", price: "$3.99", image: require("../../assets/images/latte.png") },
  "3": { title: "Cappuccino", price: "$3.49", image: require("../../assets/images/cappuccino.png") },
};
